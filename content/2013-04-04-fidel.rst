...
After writing shell scripts that find files matching NAME and/or TIME parameters and `create tar archives <tartime-find-time-tar.html>`_ or `convert video to audio <video2audio.html>`_ I wanted a script that could find and delete files. Example: *Find all MP4 files modified in the last 7 days, provide a total count, and prompt to confirm file deletion before erasure.*
