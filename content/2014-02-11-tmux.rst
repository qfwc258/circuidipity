...
`Home Server Project #3 .: <http://www.circuidipity.com/raspberry-pi-home-server.html>`_ **Tmux** is a **terminal multiplexer**. What this means is I can take a single terminal window and create multiple **windows** (tabs) and further partition a window into horizontal and vertical **panes**.
