...
:slug: tmux
:tags: shell, linux, home server
:modified: 2014-12-08 00:03:00
...
`Home Server Hack #2 ... <http://www.circuidipity.com/home-server-hacks.html>`_ **Tmux** is a **terminal multiplexer**. What this means is I can take a single terminal window and create multiple **windows** (tabs) and further partition a window into horizontal and vertical **panes**.
