...
Blinking an LED is the 'Hello World' of hardware. `BeagleBone Black's <getting-started-with-beaglebone-black.html>`_ LEDs can be controlled by the user and the device can be connected with external LEDs.
