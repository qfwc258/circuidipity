...
`bBook.py <https://github.com/vonbrownie/homebin/blob/master/bBook.py>`_
...
`bMap.py <https://github.com/vonbrownie/homebin/blob/master/bMap.py>`_
...
`webWatch.py <https://github.com/vonbrownie/homebin/blob/master/webWatch.py>`_
